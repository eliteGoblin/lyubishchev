...
aug_17_events_buffered: list[Event] = [
    Event(
        metadata=Metadata(
            label={
                "type": "bed",
        ...
        extra_info="bed",
        timestamp=arrow.get(datetime(2022, 8, 17, 00, 21, 00), "Australia/Sydney"),
    ),
    Event(
        metadata=Metadata(
            label={
        ...
        extra_info="morning wakeup, wrap up",
        timestamp=arrow.get(datetime(2022, 8, 17, 6, 5, 20), "Australia/Sydney"),
    ),
    Event(
        metadata=Metadata(
            label={
